...
local notificationFont = dxCreateFont('client/notifications/files/fonts/roboto.ttf', 12 * 2, false);
local iconsFont = dxCreateFont('client/notifications/files/fonts/icons.ttf', 12 * 2, false);
